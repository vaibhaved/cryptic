			...
			<div class="wrap-login100 p-t-190 p-b-250">
				<div id="main" class="table-wrapper" style="color:#ffffff; border-top: 1px solid #ffffff; border-bottom: 1px solid #ffffff">
					...
					<a href="<?php echo $name ?>" id="level" target="_blank" style="font-size:20px; color: #ffffff" onmouseover="mouseover()" onmouseout="mouseout()">
						<b>CLICK HERE TO ACCESS THE LEVEL</b>
					</a>
					<p>
						<form method="post" action="submission.php">
							<div class="field">
								<label for="name">Answer : </label>
								<input type="text" class="input100" name="answer" id="name" value="" required/>
							</div>
							<center>
...
<!--===============================================================================================-->
	...
	<script type="text/javascript">
		...
		if(i=="1"){
			...
			document.getElementById('tempPara').innerHTML="<b>Cryptic Hunt is now Over</b>";

		}
		else if(k=="1"){
			document.getElementById('main').remove();
			document.getElementById('tempPara').innerHTML="<b>Cryptic Hunt will start at 11:00 PM, 20th April</b><br><b>Hit reload or press ctrl + R to access quiz once quiz starts.</b>"
